...
# Reserve IP address. After you've set up your Cloud Storage buckets, you can reserve a global static external IP address that your audience uses to reach your load balancer.
